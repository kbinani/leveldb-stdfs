...
Status DestroyDB(const std::string& name, const Options& options) = delete;
Status DestroyDB(const std::wstring& name, const Options& options) = delete;
...
LEVELDB_EXPORT Status RepairDB(const std::filesystem::path& dbname,
                               const Options& options);
Status RepairDB(const std::string& dbname, const Options& options) = delete;
Status RepairDB(const std::wstring& dbname, const Options& options) = delete;
